...
<img width="400" alt="sctNfunSagCrop" src="https://github.com/user-attachments/assets/224dd2b6-dfe8-4a18-b650-ef9a08d2e85d" />

## Problem: Visualization (and registration) of multiple auto-aligned images is difficult
One usually overlay function images (e.g. the two single slices in color below, each from a different auto-aligned run) on top of a reference anatomical image (e.g. the grayscale image below).
